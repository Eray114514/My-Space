  ...
  return (
    <div className="max-w-3xl mx-auto py-10 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <header className="text-center space-y-4 pt-4">
        <h1 className="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white">文章</h1>
        <p className="text-lg text-gray-500 dark:text-gray-400 font-light">思考、教程与碎片。</p>
      </header>
