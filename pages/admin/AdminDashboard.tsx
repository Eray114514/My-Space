...
import { Plus, Trash2, Edit2, Save, Globe, Search, X, Settings, Sparkles, Loader2, BrainCircuit, Wand2, DownloadCloud, Layout, Zap, Bot, Box, CheckCircle, Link as LinkIcon, AlignLeft, Type } from 'lucide-react';
                  ...
                  <div className="w-full relative z-10">
                    ...
                    {formData.iconType === 'generated' && (
                      <div className="w-full">
                        ...
                        <p className="text-[10px] text-center mt-2 text-gray-400">Powered by {
                          // @ts-ignore
                          AI_MODELS[defaultSvgProvider]?.shortName || 'AI'
                        }</p>
                      </div>
                    )}
                  </div>
